...
export default function JudgeCourseSlider() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="font-display text-2xl font-semibold text-gray-900">{t("courseSectionTitle")}</h2>
        <div className="mt-3 h-px w-8 bg-brand-gold" />
        <p className="mt-3 text-sm leading-relaxed text-gray-500">{t("courseSectionDesc")}</p>
      </div>
      <ImageSlider slides={slides} aspectClass="aspect-[16/9] md:aspect-[21/9]" />
    </div>
  );
}
